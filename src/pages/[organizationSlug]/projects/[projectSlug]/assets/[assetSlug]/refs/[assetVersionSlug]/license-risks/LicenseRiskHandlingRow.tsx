...
import { licenseRisk, VulnByPackage, VulnWithCVE } from "@/types/api/api";
...
const LicenseRiskHandlingRow: FunctionComponent<Props> = ({
  row,
  index,
  arrLength,
}) => {
...
export default LicenseRiskHandlingRow;
