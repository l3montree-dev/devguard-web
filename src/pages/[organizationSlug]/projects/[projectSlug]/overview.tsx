      ...
      >
        <div className="grid grid-cols-4 gap-4">
          <SeverityCard
            variant="critical"
            amountByRisk={
              riskDistribution?.reduce((acc, r) => acc + r.critical, 0) ?? 0
            }
            amountByCVSS={
              cvssDistribution?.reduce((acc, r) => acc + r.critical, 0) ?? 0
            }
          ...
          <SeverityCard
            variant="high"
            amountByRisk={
              riskDistribution?.reduce((acc, r) => acc + r.high, 0) ?? 0
            }
            amountByCVSS={
              cvssDistribution?.reduce((acc, r) => acc + r.high, 0) ?? 0
            }
          ...
          <SeverityCard
            variant="medium"
            amountByRisk={
              riskDistribution?.reduce((acc, r) => acc + r.medium, 0) ?? 0
            }
            amountByCVSS={
              cvssDistribution?.reduce((acc, r) => acc + r.medium, 0) ?? 0
            }
          ...
          <SeverityCard
            variant="low"
            amountByRisk={
              riskDistribution?.reduce((acc, r) => acc + r.low, 0) ?? 0
            }
            amountByCVSS={
              cvssDistribution?.reduce((acc, r) => acc + r.low, 0) ?? 0
            }
