...
interface Props {
    form: UseFormReturn<OrganizationDTO, any, undefined> | UseFormReturn<OrganizationDetailsDTO, any, undefined>
}
...
export const OrgForm: FunctionComponent<Props> = ({ form }) => (
    <>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Select autoComplete="country-name" onValueChange={field.onChange}
        ...
        <Section title="Members" description="Manage the members of your organization.">
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-6">
                </div>
            </div>
