...
import { beautifyPurl, extractVersion } from "src/utils/common";
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded border border-foreground/20 bg-muted">
                          <EcosystemImage size={16} packageName={entry.purl} />
                        </div>
                        <Link
                          href={`https://docs.devguard.org/package-inspector/${encodeURIComponent(entry.purl)}`}
                          target="_blank"
