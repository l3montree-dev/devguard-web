  ...
  return (
    <div className="flex gap-x-3">
      <input
        id={id}
        ref={ref}
        className="relative top-1 h-4 w-4 rounded-sm border border-gray-300 bg-white text-amber-500 shadow-sm focus:ring-blue-400 dark:border-gray-600  dark:bg-gray-700"
        type="checkbox"
        {...rest}
      ></input>
      <div>
