...
const ExternalEntityAutosetup: FunctionComponent<Props> = ({
  handleAutosetup,
  progress,
  Loader,
  onClose,
    ...
    <CarouselItem>
      <DialogHeader>
        <DialogTitle className="flex flex-row gap-2">
          <SparklesIcon className="w-5 text-muted-foreground" />
        ...
        <DialogDescription>
          ...
          {asset?.repositoryName && <span> {asset?.repositoryName}</span>}. This
          will create a Merge-Request and add any missing configuration
      ...
      <div className="flex flex-row gap-2 justify-end">
        <Button
          variant={"secondary"}
          id="external-entity-auto-setup-back"
          onClick={() => {
...
export default ExternalEntityAutosetup;
