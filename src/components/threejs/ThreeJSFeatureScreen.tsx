...
const ThreeJSFeatureScreen = () => {
  return (
    <div className="relative w-3/5 bg-background">
        ...
        <div className="mt-2 flex flex-col gap-4">
          <div className="flex gap-4 flex-row">
            ...
            <div className="flex-1">
              <span className="font-medium">Get AppSec done with ease</span>
      ...
      <div className="absolute pointer-events-none w-1/2 bg-card/50 p-5 backdrop-blur-lg rounded-lg bottom-0 m-20 right-0 z-10">
        <div className="mt-2 flex flex-col gap-4">
          <div className="flex gap-4 flex-row">
            <div className="rounded-full bg-card w-10 h-10 flex flex-row items-center justify-center border">
