...
const RainbowMaterial = shaderMaterial(
  ...
  /*glsl*/ ` varying vec2 vUv;
    ...
    void main() {
      ...
      // Replace black with #0C1118
      vec3 bg = vec3(12.0/255.0, 17.0/255.0, 24.0/255.0);
      vec3 finalColor = mix(bg, co, step(0.01, co.r + co.g + co.b));

      gl_FragColor = vec4(area * finalColor * l * brightness * emissiveIntensity, 1.0);
