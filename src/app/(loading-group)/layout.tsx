...
import { ScannerImageProvider } from "../../context/ScannerImageContext";
...
export default async function Layout({
  ...
  const latestScannerImage = await fetchLatestScannerImage();

  return (
    <ClientContextWrapper
      Provider={ScannerImageProvider}
      value={latestScannerImage}
    >
      <RootHeader />
