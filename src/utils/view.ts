...
export function getArtifactNameFromScannerID(scannerID: string): string {
  // github.com/l3montree-dev/devguard-scanner/cmd/sbom:registry.opencode.de/bmi/opendesk/components/community/images-mirror/cassandra-exporter:2.3.8-debian-12-r46@sha256:3b460a6287f24ef96626439825c9e3fa822784d802209f38c7541d8289eb51d8
  ...
  if (parts.length > 0) {
    ...
    if (parts.length > 1) {
      artifactName += ":" + parts.slice(1).join(":");
    }
